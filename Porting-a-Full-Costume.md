...
4. For verification of the new weights we import an original animation. Especially for roll bones which correct parts which would look ugly from rotating natural joint - elbows e.i. - the original animations show us what we will see in the game (except for the customization of the character).  
